...
label chapter2piaafterrooftop:
    "Akhirnya [mcname] duduk di sebelah Pia sambil melihat pemandangan dari rooftop, melihat jauh ke depan. Lalu menuangkan pemandangan indah itu dalam sebuah lukisan. Tugas gambar [mcname] untuk UTS, selesai."
    stop music fadeout 1.0
    $ quick_menu = False
    scene black with dissolve
    ...
    mcname "Apaan ini?"
    show pia_side at left with dissolve
    pia "Pake ini buat mengabulkan 1 permintaan. Apapun itu, akan kulakukan!"
    hide pia_side with dissolve
    ...
    "[mcname] dan Pia pun belajar bersama di cafe tersebut sampai larut malam, dan [mcname] pun memutuskan meminjamkan buku tersebut ke Pia."
    $ quick_menu = False
    stop music fadeout 1.0
    scene black with dissolve
