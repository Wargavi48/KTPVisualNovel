...
label chapter1pia2:
    ...
    hide pia_side with dissolve
    mcname "eh bukannya kamu kemaren minta nomer kak Fiony? kenapa gak hubungin dia buat nanya?"
    show pia_side at left 
    ...
    hide pia_side with dissolve
    "Fiony" "maap ya [mcname], tadi nunggu pia dandan dulu lama banget, mana macet pula di jalan"
    show pia_side at left
    pia "dih kok cepio nyalahin aku!!!!"
    hide pia_side with dissolve
    "Fiony" "tapi kan emang dandannya lama tadi, kan cuma mau belanja cat, buku, dll kan?"
    "Fiony" "ngapain harus dandan banget yang banget banget?"
    "Fiony" "apa jangan jangan kamu s--"
    show pia_side at left
    pia "ssssssaaaaah. dah dah, jadi kemana mana ini. lesgo lead the waaaay cepio!!!!"
    hide pia_side with dissolve
    ...
    "Fiony" "cepio aja, panggil aku cepio aja"
    pia "*bombastic side eye ke cepio*"
    mcname "ah oke, cepio hehe *blush*"
    show pia_side at left
    pia "hmmmmmm!!! *marah*"
    hide pia_side with dissolve
    "Fiony berbisik ke pia"
    "Fiony" "Cieee cemburu"
    show pia_side at left
    pia "CEPIOOOOOOOO"
    hide pia_side with dissolve
    ...
    hide pia with dissolve
    hide pia_side with dissolve
    "MC, Pia, dan Fiony selesai membeli peralatan yang dibutuhkan untuk DKV"
    show pia at char_placement with dissolve
    show pia_side at left
