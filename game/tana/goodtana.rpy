...
#chapter2tanaGOOD2
    ...
    show flora_side_talk at left
    with dissolve
    flora "Weh? Tumben kalian ke sini."
    hide flora_side_talk at left
    hide flora_talk at flora_left
    hide feni at feni_right
    show tana_talk at tana_near
    show tana_side_talk at left
    with dissolve
    tana "Iya, kak. Kita mau belajar bareng buat UTS. Numpang tempat di sini boleh ya, hehehe…"
    hide tana_side_talk at left
    hide tana_talk at tana_near
    show flora at flora_left
    show feni_talk at feni_right
    show feni_side_talk at left
    with dissolve
    feni "Boleh dong. Kan ini ruangan kalian juga."
    feni "Tuh liat, Flora aja ngumpet di sini. Dia kabur dari dosen soalnya ditagihin laporan terus dari kemarin, tapi sama dia ga dikumpulin."
    hide feni_side_talk at left
    hide feni_talk at feni_right
    hide flora at flora_left
    show feni at feni_right
    ...
    show flora_side_talk at left
    with dissolve
    flora "Hadeh, sini masuk aja. Kalau kalian ada yang bingung, tanya aja."
    hide flora_side_talk at left
    hide flora_talk at flora_left
    hide feni at feni_right
    show tana_talk at tana_near
    ...
    show flora_side_talk at left
    with dissolve
    flora "Lah? Maksudnya kalo kalian nanya, silahkan. Tapi belum tentu aku jawab juga, hahaha!"
    hide flora_side_talk at left
    hide flora_talk at flora_left
    show flora at flora_left
    with dissolve
    ...
    show flora_side_talk at left
    with dissolve
    flora "Hahaha, bercanda."
    hide flora_side_talk at left
    hide flora_talk at left
    hide feni at feni_right
    with dissolve
    "Mereka berempat pun larut dalam kegiatannya masing-masing."
    $ quick_menu = False
    scene black with dissolve
    scene kelas with dissolve
    $ quick_menu = True
    ...
    show feni_side_talk at left 
    with dissolve
    feni "Flyer lomba dance kemarin udah dikasih ke Tana?"
    hide feni_side_talk at left
    hide feni_talk at feni_center
    show feni at feni_center
    with dissolve
    ...
    show flora_side_talk at left
    with dissolve
    flora "Hmmm. Kalau kamu kasih sekarang, gimana?"
    hide flora_side_talk at left 
    ...
    scene kelas with dissolve
    $ quick_menu = True
    "Sinar cahaya sore mulai memasuki ruangan club. Pertanda waktu petang mulai menyapa."
    mcname "Hoaaaam~"
    ...
    show feni_side_talk at left
    with dissolve
    feni "Siapa bilang ga ada?! Kita mau kok. Ya ga, Flo?"
    hide feni_side_talk at left
    hide feni_talk at feni_right
    hide flora at flora_left
    show feni at feni_right
    ...
    show flora_side_talk at left
    with dissolve
    flora "Bener tuh. Apalagi abis lihat video dance lu yang viral. Siapa juga yang ga mau, ya kan?"
    hide flora_side_talk at left
    hide flora_talk at flora_left
    show flora at flora_left
    with dissolve
    ...
    show flora_side_talk at left
    with dissolve
    flora "Udah Tan, ikut aja. Ga ada salahnya nyoba kan?"
    hide flora_side_talk at left
    hide flora_talk at flora_left
    show flora at flora_left
    show feni_talk at feni_right
    ...
    show flora_side_talk at left
    with dissolve
    flora "Lah? Kak Mpen gimana sih? Kan Kak Mpen yang ambil flyernya kemarin."
    hide flora_side_talk at left
    hide flora_talk at flora_left
    hide feni at feni_right
    show flora at flora_left
    ...
    show tana_side_talk at left
    with dissolve
    tana "Nah. Apalagi Kak Feni ikutan club dance juga, kan?"
    hide tana_side_talk at left
    hide tana_talk at tana_near
    show feni_talk at feni_center
    show feni_side_talk at left
    with dissolve
    feni "Waduh. Bukannya ga mau, tapi sekarang lagi aku sibuk skripsian."
    hide feni_side_talk at left
    hide feni_talk at feni_center
    show flora_talk at flora_center
    show flora_side_talk at left
    ...
    show tana_side_talk at left
    with dissolve
    tana "Weh, ide bagus. Tumben kepikiran."
    hide tana_side_talk at left
    hide tana_talk at tana_near
    show tana at tana_near
    with dissolve
    ...
    show feni_side_talk at left
    with dissolve
    feni "Nah, nanti tempat pendaftarannya di sini aja."
    hide feni_side_talk at left
    hide feni_talk at feni_center
    show feni at feni_center
    with dissolve
    ...
    with dissolve
    $ quick_menu = True
    tana "Sorry agak telat. Tadi habis nempelin flyer di mading dulu."
    hide tana_side_talk at left
    hide tana_talk at tana_near
    show tana at tana_near
    with dissolve
    ...
    show tana_side_talk at left
    with dissolve
    tana "Naise. Ada yang belum kebagian, ga?"
    hide tana_side_talk at left
    hide tana_talk at tana_near
    show tana at tana_near
    with dissolve
    ...
    show tana_side_talk at left
    with dissolve
    tana "Oke. Kita ke sana, yuk."
    hide tana_side_talk at left
    hide tana_talk at tana_near
    show tana at tana_near
    with dissolve
    "Mereka berdua pun menghampiri gerombolan cewek tersebut."
    hide tana at tana_near
    show tana_talk at tana_near
    show tana_side_talk at left
    with dissolve
    tana "Permisi, kakak semua. Kita mau bagiin flyer perekrutan anggota idol group. Siapa tau kakak di sini ada yang berminat untuk join."
    hide tana_side_talk at left
    hide tana_talk at tana_near
    with dissolve
    "ASSET FLYER REKRUT ANGGOTA IDOL"
    ...
    show tana_side_angry_2 at left
    with dissolve
    tana "EH, LU, DASAR CEWE… AKKKHHHHH! SINI LU MAJU SEMUA. GUE GA TAKUT!!!"
    hide tana_side_angry_2 at left
    hide tana_angry_2 at tana_near
    with dissolve
    "Mahasiswi 3" "APA?! LU PIKIR GUE TAKUT!?"
    show tana_angry_2 at tana_near
    show tana_side_angry_2 at left
    with dissolve
    tana "CANGKEMAN, BOCAH RA DUWE UNGGAH-UNGGUH. RA NGAJENI BLAS!!\n(DASAR GAK PUNYA SOPAN SANTUN! GAK MENGHARGAI SAMA SEKALI!)"
    hide tana_side_angry_2 at left
    hide tana_angry_2 at tana_near
    show tana_angry at tana_near
    with dissolve
    ...
    show tana_side_angry_2 at left
    with dissolve
    tana "GA! AKU GA TERIMO LEK DINGENENO!\n(GA! AKU GA TERIMA KALO DIGINIIN!)"
    hide tana_side_angry_2 at left
    hide tana_angry_2 at tana_near
    show tana_angry at tana_near
    with dissolve
    ...
    "Tana dan [mcname] pun pergi dari kantin dan meninggalkan gerombolan cewek tersebut."
    stop music fadeout 1.0
    $ quick_menu = False
    scene black with dissolve
    play music "audio/BGM_Kampus.mp3" fadein 1.0
    ...
    $ quick_menu = True
    mcname "Tan, lu harus lebih sabar.. Gimana kalau ada yang mau daftar, tapi akhirnya ga jadi karena liat kamu emosi gitu."
    hide tana_angry at tana_near
    show tana_angry_2 at tana_near
    show tana_side_angry_2 at left
    with dissolve
    tana  "Ya gimana, mereka udah keterlaluan banget. Mereka ga tau usaha kita buat sebarin ini flyer."
    hide tana_side_angry_2 at left
    hide tana_angry_2 at tana_near
    show tana_angry at tana_near
    with dissolve
    ...
    hide tana_angry_2 at tana_near
    with dissolve
    "Tana pun mengusap-usap mukanya seperti akan membentuk wajah baru."
    show tana_talk at tana_near
    show tana_side_talk at left
    with dissolve
    tana "Udah nih. Puas lu?!"
    hide tana_side_talk at left
    hide tana_talk at tana_near
    show tana at tana_near
    with dissolve
    ...
    with dissolve
    tana "Dasar..."
    tana "Eh btw, kayaknya gue pernah lihat cewe rambut biru itu deh."
    hide tana_side_talk at left
    hide tana_talk at tana_near
    show tana at tana_near
    with dissolve
    ...
    show tana_side_talk at left
    with dissolve
    tana "Itu! Biru kayak gitu, masa ga keliatan?"
    hide tana_side_talk at left
    hide tana_talk at tana_near
    show tana at tana_near
    with dissolve
    ...
    show tana_side_talk at left
    with dissolve
    tana "Gatau. Gue juga bingung dia kenapa."
    hide tana_side_talk at left
    hide tana_talk at tana_near
    show tana at tana_near
    with dissolve
    ...
    show flora_side_talk at left
    with dissolve
    flora "Iya. Udah dari siang tadi, habis kelas selesai."
    hide flora_side_talk at left
    hide flora_talk at flora_left
    hide feni at feni_right
    show flora at flora_left
    ...
    show feni_side_talk at left
    with dissolve
    feni "Udah, jangan terlalu dipikirin. Pasti nanti ada jalannya, kok. Tenang aja."
    hide feni_side_talk at left
    hide feni_talk at feni_right
    hide flora at flora_left
    show feni at feni_right
    ...
    show flora_side_talk at left
    with dissolve
    flora "Nah, mending kalian fokus UTS dulu aja. Gue yang malu kalo sampe kalian ga lulus."
    hide flora_side_talk at left
    hide flora_talk at flora_left
    show flora at flora_left
    with dissolve
    ...
    show feni_side_talk at left
    with dissolve
    feni "Mana sini flyernya. Nanti aku kasih ke anak-anak club dance, deh."
    hide feni_side_talk at left
    hide feni_talk at feni_right
    hide flora at flora_left
    show feni at feni_right
    ...
    show feni_side_talk at left
    with dissolve
    feni "Sama-sama. Kalian berdua belajar yang rajin."
    hide feni_side_talk at left
    hide feni_talk at feni_right
    show feni at feni_right
    with dissolve
...
#TrueEndingFINALE
    ...
    show kana_side_talk at left
    with dissolve
    kana "Kalau aku sih karena dari dulu aku suka jejepangan dan kebetulan juga aku kadang suka nyanyi sama ikut event event offline gitu."
    kana "Jadinya yaa pengen nyoba aja, hehe."
    hide kana_side_talk
    hide kana_talk
    hide pia
    show kana at kana_near_left_2
    ...
    show pia_side_talk at left
    with dissolve
    pia "Kalau gua sih suka nyanyi, tapi malu aja kalau ikut lomba nyanyi. Terus kebetulan liat deh poster idol ini, yaudah gue coba aja sekalian."
    hide pia_side_talk
    hide pia_talk
    show pia at pia_near_right
    with dissolve
    ...
    show pia_side_silent at left 
    with dissolve
    pia "Eh, diem, lu. Lu sebenarnya bisa, kan? Tadi gue liat juga lu kadang sengaja salah gitu. Lu pasti bisa soalnya lu kan sering ikut event dan liat video idol gitu. Ga usah sengaja-sengaja disalahin gitu, gue ga suka."
    hide pia_side_silent 
    hide pia_silent
    show tana_angry_2 at tana_near
    show tana_side_angry_2 at left 
    ...
    show feni_side_talk at left 
    with dissolve
    feni "Kalian teriak-teriak ngapain?! Kalian sadar ga kalau suara kalian tu kedengeran sampai ke luar?!"
    hide feni_side_talk
    hide feni_talk
    hide flora
    show feni at feni_right
    ...
    hide kana
    with dissolve
    "Mereka pun mulai melakukan latihan mereka seperti biasanya. Akan tetapi, atmosfer antara Pia dan Tana masih terasa."
    $ quick_menu = False
    scene black with Dissolve(2.0)
    scene ruang ukm with Dissolve(2.0)
    show tana_talk at tana_near
    ...
    $ quick_menu = False
    scene black with Dissolve(2.0)
    "Dibantu dengan Feni dan Flora, Tana dan Pia melakukan latihan mereka secara terpisah. Feni mengajarkan Pia cara nge-dance, sedangkan Flora mengajarkan Tana cara bernyanyi."
    "Karena tempat latihan Tana dan Pia terpisah, [mcname] pun bergantian datang ke tempat latihan Tana dan Pia. Di situ ia tahu bahwa masing-masing dari mereka sangatlah berusaha dalam berlatih."
    play music "audio/BGM_UKM.ogg" loop fadein 1.0
    scene ruang ukm with Dissolve(2.0)
    $ quick_menu = True
    "Beberapa hari telah berlalu. Feni serta Flora pun memutuskan untuk melakukan latihan bersama kembali di ruang klub."
    show flora at flora_left
    show feni_talk at feni_right
    show feni_side_talk at left 
    with dissolve
    ...
    show tana_side_angry_2 at left
    with dissolve
    tana "Heh, Bocil, gua tunjukin nih skill nyanyi gua."
    hide tana_side_angry_2
    hide tana_angry_2
    show pia_silent at pia_near
    show pia_side_silent at left 
    ...
    show tana_side_talk at left 
    with dissolve
    tana "Ya kali lu doang yang improve. Gua juga improve habis latihan sama Flora-senpai."
    hide tana_side_talk 
    hide tana_talk
    hide pia
    hide kana
...
#HARUSNYA BG Event Jejepangan
    play sound "crowd_noise.mp3" loop fadein 1.0
    $ quick_menu = True
    "Di parkiran kampus..."
    show tana_talk at tana_near
    show tana_side_talk at left 
    ...
    $ quick_menu = False
    scene black with Dissolve(2.0)
    play music "audio/BGM_Lorong.mp3" loop fadein 1.0
    scene lorong with Dissolve(2.0)
    $ quick_menu = True
...
#Sfx tendang
    ...
    show tana_side_shy at left with dissolve
    tana "Makasih..."
    hide tana_side_shy with dissolve
    #Narator
    ...
    show tana_side_shy at left
    with dissolve
    tana "Gimana jelasinnya, ya? Intinya, gue ga pede dengan pakaian feminin kayak gini."
...
label goodtanagotofestival:
    ...
    mcname "Masih 2 Jam lagi kan kalian tampil?"
    hide tana_idol
    show tana_idol_talk at tana_near
    show tana_side_talk at left 
    with dissolve
...
#Sprite Feni Mundur
    ...
    hide tana_idol_silent
    show tana_idol_angry_2 at tana_near
    show tana_idol_angry_2
    with dissolve
    tana "Gausah gitu. Lu juga sama aja, kocak."
    hide tana_idol_angry_2 
    hide tana_idol_angry_2
    show tana_idol_angry at tana_near
    with dissolve
    ...
    $ quick_menu = False
    scene black with Dissolve(2.0)
    scene lorong malam with Dissolve(2.0)
    $ quick_menu = True
...
#Sfx vibrate
    ...
    tana "Makasih udah ngajak keliling-keliling."
    hide tana_side_talk 
    hide tana_idol_talk
    show tana_idol at tana_near
    with dissolve
