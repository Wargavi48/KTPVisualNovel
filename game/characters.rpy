...
default kana_clumsy = Character("[kana_name]", image="Kana_clumsy", window_background="gui/dialog/custom_dialog_kana.png",window_yalign=0.862,window_xpos=1340,who_yalign=1.0,who_xpos=-300,what_ypos=80,what_xpos=70)
default kana_embarased = Character("[kana_name]", image="Kana_embarased", window_background="gui/dialog/custom_dialog_kana.png",window_yalign=0.862,window_xpos=1340,who_yalign=1.0,who_xpos=-300,what_ypos=80,what_xpos=70)
