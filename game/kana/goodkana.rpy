...
label goodkanaafterorder:
  ...
  "Ada juga beberapa pembicaraan mengenai event yang akan datang dan apa saja tugas yang akan dilakukan oleh [mcname] dan Kana."
  stop music fadeout 1.0
  #*SKIP SCENE*
  #*BG KAMAR KOS MALAM*
  $ quick_menu = False
  ...
  hide kana_side with dissolve
  mcname "{i}Waduhhh, kenapa ini kok Si Kana tiba-tiba kaya gini? Aduhhh kok gue gugup gini?{/i}"
  mcname "I-iya Nay, kenapa tumben kok jadi serius gini."
  show kana_side at left with dissolve
  kana "Se-sebenernya…"
  kana "A-akuuu…"
  ...
  kana "Fiuuuuhhh, akhirnya bisa juga. Dari tadi aku gugup tau mau ngomong itu, hahaha. Jadi kamu juga ikut kan [mcname]?"
  hide kana_side with dissolve
  mcname "{i}Oalahh ternyata Kana mau ngomongin itu… Kukira mau ngomong apaan. Aduhhhh aku ke-PDan, aaaaaaa~{/i}"
  show kana_side at left with dissolve
  ...
  "Kana memelankan suaranya seperti sengaja tidak ingin terdengar oleh [mcname]."
  kana "Sama kamu juga…"
  hide kana_side with dissolve
  mcname "Hmmm Nay?"
  show kana_side at left with dissolve
  ...
  "Di akhir rapat tersebut pun Pia dan Tana memanggil Kana dan [mcname]." 
  show tana_side at left with dissolve
  ...
  kana "Engga gak gak. Ga mau dan ga mungkin aku ikut sama lomba, pokoknya enggaaak…"
  hide kana_side with dissolve
  show tana_side at left with dissolve
  ...
  hide kana_side with dissolve
  show tana_side at left with dissolve
  tana "Alah malu-malu, waktu itu aja lu dulu di event jejepangan teriak paling kenceng gitu."
  hide tana_side with dissolve
  show kana_side at left with dissolve
  ...
  "Baik [mcname], Pia, serta Tana, memohon dengan sangat… Membuat Kana semakin terdesak."
  ...
  "Setelah itu Kana, [mcname], Tana, dan Pia mengerjakan tugas yang telah diberikan oleh ketua panitia."
  stop music fadeout 1.0
  $ quick_menu = False
  #*SKIP TO SCENE*
  #*BG KOS MALAM*
  ...
  tana_nvl "Aaaaaaa….udah lah biar ga ribet juga, @Kana & @[mcname] woiii keluar napa? Jangan diem-diem ae"
  ...
  kana_nvl "Ummm… Boleh sih, tapi [mcname] juga ikut nemenin kan? Inget perjanjian awal ya, kalau dia ga ikut aku juga enggak."
  ...
  hide kana_side with dissolve
  mcname "NAYA!!..."
  "[mcname] berteriak cukup kencang hingga Pia dan Tana pun terkejut dengan suara [mcname]." 
  mcname "KANAIA ASA, please don't be like that. It’s ok to make mistakes, mistakes happen. Santai aja Nay, mereka ga bakalan salahin kamu kok. Kalaupun mereka berani, bakal kugetok mereka kok. Jadi just be you, ok?"
  show kana_side at left with dissolve
  kana "T-tapi…"
  hide kana_side with dissolve
  ...
  pia "Oke kalau gitu dulu juga pas Si Pia Pia itu ngedance beuhhh, jatuh terus brooo. Mana nangis juga, aduhhh dede kecil nangisss."
  hide tana_side with dissolve
  show pia_side at left with dissolve
  ...
  $ quick_menu = True
  #Narator
  "[mcname] mengingat kembali perjuangan Kana saat latihan."
  ...
  hide kana_side with dissolve
  "Kana pun kebingungan. Ia melihat ke arah Tana dan [mcname], akan tetapi Tana hanya bisa diam." 
  mcname "Piia?"
  show pia_side at left with dissolve
  pia "Bentar ya [mcname], ini aku sama Kana dulu. Oke Kana, jadi…"
  hide pia_side with dissolve
  ...
  hide pia_side with dissolve
  "Tiba-tiba Tana menarik lengan [mcname], seakan ingin berbicara dengannya secara personal."
  show tana_side at left with dissolve
  tana "Eh [mcname], maaf ya kalau Si Pia agak gimana gitu komennya. Soalnya ke gue juga lebih parah, tapi habis itu vocal gue improve bangettt."
  hide tana_side with dissolve
  ...
  hide tana_side with dissolve
  "Di perjalanan pulang, [mcname] memikirkan Kana. Ia tampak agak berbeda dari biasanya, seakan ada yang membuat dia gelisah. Tetapi yang ada di pikiran [mcname] hanya mimik muka Kana sesaat setelah diberi komentar oleh Pia…"
  ...
  scene kamar mc kota with dissolve
  $ quick_menu = True
  mcname "{i}Hmmm, enaknya gimana ya mulainya?{/i}"
  #*INSERT HP*
  nvl clear
  mc_nvl "Malam Nayy.."
...
label goodkanameetinhome:
  ...
  $ quick_menu = True
  "[mcname] pun mendatangi rumah Kana tepat jam 12. Merasa hal ini adalah sesuatu yang penting, [mcname] tidak ingin membuat Kana kecewa karena telat."
  show kana_side at left with dissolve
  kana "Eh, masuk aja."
  hide kana_side with dissolve
  mcname "Ohh iya…"
  "Terdapat ketenangan sejenak di antara Kana dan [mcname]. Kana yang merasa takut untuk bercerita dan [mcname] yang ingin bertanya tapi merasa tidak enak, membuat keduanya tidak dapat memulai pembicaraan. Sampai pada akhirnya…"
  ...
  hide kana_side with dissolve
  "[mcname] hanya diam saja, ia tidak ingin menyela cerita dari Kana." 
  show kana_side at left with dissolve
  ...
  mcname "INGET, GA BOLEH NYELA."
  mcname "Ok?"
  show kana_side at left with dissolve
  kana "O-oke."
  hide kana_side with dissolve
  mcname "Dancemu off tempo… off ketukan… emang kenapa Nay? Emang mereka komen soal itu? Enggak, kan?"
  mcname "Ini pertama kalinya dance buat kamu kan? Dan mereka aja muji kamu, Naya, ga usah berkecil hati."
  mcname "Soal vokal, kalo kamu mau tau, Si Tana sampe minta tolong buat sampein permintaan maaf ke kamu."
  mcname "Dia bilang kalo Si Pia emang ngajarinnya kaya gitu, tapi niat dia kan baik. Buktinya kamu sekarang tau teknik vokal lainnya."
  "Kana yang hanya bisa terdiam menundukan kepalanya."
  mcname "Yang lebih penting dari semua itu ada kamu, Kanaia Asa. Apa kamu seneng belajar bareng dan temenan sama mereka?"
  ...
  mcname "{i}Okeee, pokoknya aku harus bisa dukung Kana sampe perlombaan! Jangan sampe kana punya pikiran negatif lagi!{/i}"
  stop music fadeout 1.0
  $ quick_menu = False
  #*SKIP TO SCENE*
  #*BG RUANG KLUB*
  ...
  hide tana_side with dissolve
  "Padangan dari ketiganya mengarah ke [mcname], seakan meminta [mcname] untuk memberikan tempat yang cocok untuk latihan."
  ...
  menu:
    ...
    "TANAH KOSONG DI UJUNG KAMPUS":
      ...
      hide pia_side with dissolve
      show kana_side at left with dissolve
      kana "[mcname], serius kan di sini?"
      hide kana_side with dissolve
    ...
    "DIBAWAH POHON":
      ...
      hide tana_side with dissolve
      show kana_side at left with dissolve
      kana "Oke juga pilihanmu, [mcname]."
      hide kana_side with dissolve
      show pia_side at left with dissolve
...
label goodkanadancepractice:
  ...
  "Akan tetapi saat [mcname] membuka pintu, dia melihat sesuatu yang sedang terjadi."
  show pia_side at left with dissolve
  ...
  mcname "Bentar-bentar, coba pelan-pelan deh ini masalahnya apa dah."
  show pia_side at left with dissolve
  ...
  hide pia_side with dissolve
  mcname "Udah udah"
  mcname "Mending kalian semua minum sama nyemil dulu dah, ini lagi panas-panasnya emang. Meskipun ada angin sepoi-sepoi, tapi cahayanya tetap panas. Minum dulu sana."
  ...
  mcname "Okeee, ini pandangan gue ya. Jadi kalo kata Pia, Si Tono harusnya bisa nge-guide kan? Tapi Tono ga bisa nge-guide terus-terusan karena harus lihat rekaman, ya? Dan Kana, kamu jangan mulai salahin diri sendiri lagi oke?"
  show kana_side at left with dissolve
  kana "Ehh… Uummm"
  hide kana_side with dissolve
  show tana_side at left with dissolve
  ...
  pia "I-iya juga sih"
  hide pia_side with dissolve
  mcname "Oke kalo gitu gue yang liat dan bantu rekam aja deh, nanti gue kasih rekamannya."
  mcname "Buat Pia, tetep kasih tau aja kalo ada yang off tempo."
  show kana_side at left with dissolve
  ...
  show tana_side at left with dissolve
  tono "Iya Pii. Tadi sorry ya, gue kebawa emosi. Keknya karena emang panas sih, hehehe."
  hide tana_side with dissolve
  show pia_side at left with dissolve
  ...
  hide tana_side with dissolve
  mcname "Eeh udah kali ya buat hari ini, rooftop udah mau ditutup."
  mcname "Tadi ada satpam yang ngasih tau aku gitu, terus aku bilang 5 menit lagi. Yuk beres-beres, jangan nyampah ya."
  show tana_side at left with dissolve
  ...
  $ quick_menu = True
  scene black with Dissolve(2.0)
  "Di suatu hari, [mcname] melihat Kana pergi ke arah rooftop sendirian. Awalnya [mcname] mengira akan ada latihan tambahan, akan tetapi di group chat tidak ada obrolan mengenai hal tersebut."
  mcname "{i}Hmmm itu kan Kana, kenapa dia sendirian ya ke rooftop? Perasaan hari ini ga ada latihan deh… Aku nyusul dah.{/i}"
  ...
  show kana_side at left with dissolve
  kana "HAAAAA!!!"
  kana "Eh [mcname]? Ku kira siapa, kaget tau."
  hide kana_side with dissolve
  mcname "Hahaha dari tadi aku panggil loh, kamu ga sadar kah? Ada apa Nay?"
  show kana_side at left with dissolve
  kana "Engg-"
  hide kana_side with dissolve
  mcname "Sebelum itu, nih minum dulu. "
  "Kana melihat ke arah [mcname]. Pandangan Kana terlihat sedih, senang, dan cemas di saat yang bersamaan."
  "Mungkin Kana memiliki banyak pikiran atau mungkin hanya ingin sendirian, tetapi Kana saat itu tahu kalau dia hanya bisa bercerita tentang hal ini kepada [mcname]."
  show kana_side at left with dissolve
  ...
  mcname "Aku ga bisa bilang apa-apa lagi, semua yang aku katakan waktu itu bener-bener apa yang ada di pikiranku."
  mcname "Kalau kamu mau tau seberapa berkembangnya kamu, nih kamu bisa lihat rekaman ini."
  "[mcname] memberikan HPnya kepada Kana. Di dalam HP tersebut ada sebuah video yang menunjukan Kana pada saat latihan pertama kali dan latihannya yang terakhir kali."
  "Kana dan [mcname] hanya terdiam melihat rekamanan tersebut. Setelah selesai, [mcname] pun mulai memberikan pendapatnya."
  ...
  hide kana_side with dissolve
  mcname "Itu dia, mereka ga pernah marah ke kamu karena mereka udah liat seberapa besar perkembangan kamu."
  mcname "Jadi, tetep semangat oke? Besok kita latihan lagi loh."
  show kana_side at left with dissolve
  kana "Makasih yaaa MC, udah mau dengerin cerita aku yang gini lagi. "
  hide kana_side with dissolve
  ...
  "Tono dan Pia memberikan beberapa saran untuk membantu Kana melakukan gerakan tersebut. Saat mencoba, Kana tiba-tiba melihat ke arah [mcname]." 
  ...
  hide kana_side with dissolve
  "Kana tersenyum ke arah [mcname]. Meskipun ia terlihat kelelahan, senyumannya tetap manis dan membuat [mcname] merasa tenang."
  show tana_side at left with dissolve
  ...
  hide tana_side with dissolve
  "Selagi tertawa dan membahas bagaimana perform nanti, waktu tak terasa sudah sore. Satpam kembali memperingatkan [mcname], Tana, Pia, dan Kana untuk segera pulang."
  ...
  mcname "Jadi gimana perasaan idol kita yang satu ini?"
  show kana_side at left with dissolve
  ...
  mcname "Tapi ya udah deh, yang penting Kana bisa semangat."  
  #*SUARA NOTIF
  ...
  "Kana pun sama, ia duduk diam tangannya yang gemetaran bisa terlihat oleh [mcname]."
  mcname "Nay, ikut aku keluar dulu yuk."
  show kana_side at left with dissolve
  kana "Eh?"
  hide kana_side with dissolve
  "[mcname] menarik tangan Kana, membuat Kana kaget dan berdiri meninggalkan kursinya."
  "[mcname] membawa Kana ke area event jejepangan."
  $ quick_menu = False
  scene black with Dissolve(2.0)
  ...
  hide kana_side with dissolve
  mcname "Ya udah ikut aja yuk, muter-muter event sini. Kita liat-liat dulu ada apa aja."  
  show kana_side at left with dissolve
  ...
  hide tana_side with dissolve
  show kana_side at left with dissolve
  kana "Eehhhh, MC. Aku duluan yaaa, aku mau siap-siap dulu."
  hide kana_side with dissolve
  mcname "Iyaa, semangat yaa."
  show kana_side at left with dissolve
