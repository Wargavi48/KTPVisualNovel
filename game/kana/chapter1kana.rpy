...
label chapter1kana2Campus:
    ...
    mcname "Huft... huft...."
    mcname "{i}Kayaknya aku harus ningkatin staminaku lagi nih.{/i}"
    ...
    if mc_from == "kos":
        ...
        hide freya
        hide kana
        show freya_shock at char_right
    ...
    if mc_from == "kos":
        mcname "{i}Eh, aku sama cewek itu!!!{/i}"
...
label chapter1kana3:
    ...
    # SUaranya hungry kurang kenceng (bahkan tanpa musik).
